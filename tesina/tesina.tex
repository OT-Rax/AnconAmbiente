...
Vengono riportati un elenco di termini presenti nell'intervista con relativa descrizione e sinonimo.
{
	...
	\begin{tabular}{|p{2,5cm}|p{6cm}|l|p{4cm}|}
		\hline
		\rowcolor{DarkGreen}
...
\scriptsize
\noindent \includegraphics[scale=0.65]{matrice_mapping}
\end{landscape}
}
...
Una volta progettati i diagrammi dei casi d'uso, attraverso la matrice di mapping possiamo verificare che ogni requisito sia soddisfatto da almeno un caso d'uso.
\\
\noindent \includegraphics[scale=0.75]{classi_generale}
\newpage

\subsection{Gestione Operatori}
\noindent \includegraphics[scale=0.55]{classi_operatori}
\subsection{Gestione Mezzi}
\noindent \includegraphics[scale=0.55]{classi_mezzi}
\newpage

\subsection{Gestione Servizi}
\noindent \includegraphics[scale=0.6]{classi_servizi}
\subsection{Gestione Turni}
\noindent \includegraphics[scale=0.6]{classi_turni}
\newpage

\subsection{Gestione Clienti}
\noindent \includegraphics[scale=0.6]{classi_clienti}
\subsection{Gestione Utenti}
\noindent \includegraphics[scale=0.65]{classi_utenti}
\newpage

\subsection{Gestione Report}
\noindent \includegraphics[scale=0.7]{classi_report}
\newpage
...
\noindent \includegraphics[scale=0.75]{sequenza_eliminaturno}
\newpage
\subsection{Inserimento Utente}
\noindent \includegraphics[scale=0.85]{sequenza_inserimentoutente}
\subsection{Creazione Report}
\noindent \includegraphics[scale=0.8]{sequenza_creazionereport}
\newpage
\subsection{Modifica Servizio}
\noindent \includegraphics[scale=0.5]{Sequenza_modifica}
\newpage
...
\noindent \includegraphics[scale=0.75]{attività_inserimentooperatore}
\newpage
\subsection{Modifica Operatore}
\noindent \includegraphics[scale=0.75]{attività_modificaoperatore}
\newpage
\subsection{Creazione Report}
\noindent \includegraphics[scale=0.75]{attività_report}
\newpage
}
...
\noindent \includegraphics[scale=0.75]{schema_db4}
...
\noindent \includegraphics[scale=0.95]{wireframe}
...
\noindent \includegraphics[scale=0.68]{mockup}
