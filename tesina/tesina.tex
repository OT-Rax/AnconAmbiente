...
La fase di Test è necessaria per andare a valutare se il software esegue correttamente tutti i suoi compiti.

\section{Test Login}
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.68]{test_login}
	\caption{Codice unit test login}
\end{figure}
...
\subsection{Test Inserimento}
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.5]{test_inserimento}
	\caption{Codice unit test inserimento operatore}
\end{figure}

\subsection{Test Ricerca}
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.68]{test_ricerca}
	\caption{Codice unit test ricerca operatore}
\end{figure}

\subsection{Test Elimina}
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.5]{test_elimina}
	\caption{Codice unit test eliminazione operatore}
\end{figure}

\subsection{Test Update}
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.5]{test_update}
	\caption{Codice unit test modifica operatore}
\end{figure}
